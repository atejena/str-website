  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-[4px] bg-surface shadow-elevated',
        'border border-border',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 font-display text-sm font-medium text-muted', className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'rounded-[2px] py-2 pl-8 pr-2',
      'text-foreground outline-none',
      'min-h-[44px]', // Accessibility: 44px touch target
      'focus:bg-str-gold focus:text-str-black',
